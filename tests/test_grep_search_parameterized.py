...
from py_code.tools.grep_search import grep_search
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [{"file_path": "file1.py", "matches": [{"line": 1, "content": "line with test_string"}], "total_matches": 1}],
        ),
        ...
        (
            ...
            [
                {"file_path": "file2.py", "matches": [{"line": 1, "content": "test"}, {"line": 2, "content": "test again"}], "total_matches": 2},
        ...
        (
            ...
            [{"file_path": "file1.py", "matches": [{"line": i+1, "content": f"test {i}"} for i in range(10)], "total_matches": 15}],
        ),
    ],
)
def test_grep_search_matches(query, include_pattern, is_regexp, matching_files, expected_matches):
    ...
    with patch("os.getcwd") as mock_getcwd, \
         ...
         patch("py_code.tools.grep_search.filter_binary_files") as mock_filter, \
        ...
        if include_pattern:
            ...
            mock_walk.return_value = [
                ("/fake/workspace", [], list(matching_files.keys()))
            ]
...
def test_grep_search_regex_handling(query, is_regexp, ctx_warning_expected):
    ...
    with patch("os.getcwd") as mock_getcwd, \
        ...
        # Call the function
        result = grep_search(query, None, is_regexp, ctx)
